...
See visual: [Main synthesis pipeline](visual-guide.md#main-synthesis-pipeline).
...
See visual: [Paper-by-paper figure map](visual-guide.md#paper-by-paper-figure-map) (Paper 3 mass-shell norm).
