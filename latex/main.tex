...
\]
This manuscript develops a conservative technical framing: local square-root mirror balance motivates closure structure, while global closure is defined by the completed residual condition $\Xi(t_n)=0$ and is not claimed as an RH proof.
\end{abstract}
